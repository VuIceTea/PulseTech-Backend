...
class OrderDtosTest {
    ...
    @Test
    void orderResponseKeepsVietnamLocalOrderTime() throws Exception {
        ...
        setCreatedAt(order, LocalDateTime.of(2026, 9, 20, 11, 53));

        OrderDtos.OrderResponse response = OrderDtos.OrderResponse.from(order);

        assertThat(response.createdAt()).isEqualTo("20/09/2026 11:53");
    }
