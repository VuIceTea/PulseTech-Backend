package vn.pulsetech.api.config;

import org.springframework.boot.ApplicationRunner;
import org.springframework.context.annotation.Bean;
import org.springframework.context.annotation.Configuration;
import vn.pulsetech.api.order.CustomerOrder;
import vn.pulsetech.api.order.CustomerOrderItem;
import vn.pulsetech.api.order.CustomerOrderRepository;
...
public class DemoDataConfig {
    ...
    ApplicationRunner demoOrder(CustomerOrderRepository orders) {
        return args -> {
            ...
            CustomerOrder order = new CustomerOrder("PT123456", "Nguyễn Văn A", "0987654321",
